#W3LF
W3LF is a wrapper around W3L. It allows the end-users to simply select the parameters sent to war3.exe. E.g: /windowed.
Besides the default features it's simply altered using Visual Studio. You can, for example, add a chat-bot inside of the W3LForm using BNet# which can be found [here](https://code.google.com/p/jinxbot/source/browse/trunk/development/projects/BNSharp/?r=35). Or newsfeed for your website, etc.

W3LF uses W3L. This software, as source, can be received [from here](https://github.com/MusicDemon/w3l).

Feel free to edit and give to the community!
